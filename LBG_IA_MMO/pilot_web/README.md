...
> **Nouvelle UI (v2)** : coquille type Cursor sous **`/pilot/v2/`** — voir `pilot_shell/README.md` et `docs/ui_refactor_plan.md`. Le pilot legacy ci-dessous reste sur **`/pilot/`** pendant la migration.
...
- **WS (test client minimal)** — *décommissionné* : legacy `mmmorpg_server :7733` (ADR 0012) ; monde actif = **Core3 Prime VM 246**. Section conservée pour réactivation opt-in (`LBG_DEPLOY_MMMORPG_WS=1`).
