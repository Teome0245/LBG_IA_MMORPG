...
- health des agents en **proxy same-origin** : `GET /v1/pilot/agent-dialogue/healthz`, `GET /v1/pilot/agent-quests/healthz`, `GET /v1/pilot/agent-combat/healthz`, `GET /v1/pilot/agent-pm/healthz` (évite d’ouvrir 8020/8030/8040/8055 depuis le navigateur).
